...
class BaselineTest7(BaseModule):
    ...
    def __init__(self, 
        ...
        block = nn.TransformerEncoderLayer(2 * dim, n_heads, device=device, dim_feedforward=2*dim_ff,
                                                batch_first=True, dropout=t_dropout)
    ...
    def forward(self, x):
        ...
        output = self.merger_tr(output, src_key_padding_mask=op_seq_mask)
