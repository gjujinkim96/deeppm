...
from .base_with_checkpoint import method_dummy_wrapper
...
class Seq(nn.Module):
    ...
    def checkpoint_forward(self, x, mask, op_seq_mask):
        """
        x: [batch_size, inst_size, seq_size, dim]
        mask: [batch_size, inst_size, seq_size]
        op_seq_mask: [batch_size, inst_size]
...
class BasicBlock(nn.Module):
    ...
    def checkpoint_forward(self, x, mask):
        """
        x: [batch_size, inst_size, seq_size, dim]
        mask: [batch_size, inst_size, seq_size]
        """
...
class Op(nn.Module):
    ...
    def checkpoint_forward(self, x, op_seq_mask):
        """
        x: [batch_size, inst_size, seq_size, dim]
        op_seq_mask: [batch_size, inst_size]
        """
